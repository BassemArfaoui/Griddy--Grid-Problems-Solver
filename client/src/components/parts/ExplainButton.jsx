      ...
      >
        ...
        >
          ...
          <div id="modal-description" className="mt-3">
            <p className="text-dark fs-4 fw-bold p-3">Watch as the shortest path is calculated and displayed on the grid! <br /> <br/> Block squares to create obstacles, and see how the path dynamically adjusts to avoid them.</p>
          </div>
        </Box>
      </Modal>
    </>
