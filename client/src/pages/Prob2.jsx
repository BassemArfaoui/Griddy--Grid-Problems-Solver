  ...
  const togglePointSelection = (x, y) => {
    ...
    if (pointExists) {
      ...
      setSelectedCoordinates((prev) =>
        prev.filter((coords) => coords[0] !== transformedX || coords[1] !== transformedY)
      );
    } else {
...
<div className="d-flex justify-content-center">
  <span
    className="my-2 equation px-3 py-2 rounded-3 fw-bold text-center " style={{cursor : 'pointer'}}
      ...
      __html:
        ...
        polynomialData.coeffs
          .map((coeff, index) => {
            ...
            const power = polynomialData.coeffs.length - index - 1;
